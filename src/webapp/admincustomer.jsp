...
<body>
	...
	<!-- SIDEBAR -->
	<section id="sidebar" style="color:forestgreen;">
		<a href="#" class="brand">
			<i class='bx bxs-smile'></i>
			<span class="text" style="color:forestgreen;">Event Admin</span>
		</a>
	...
	<section id="content">
		...
		<nav>
			...
			<a href="#" class="nav-link" style="color:springgreen;">Categories</a>
			<form action="#">
